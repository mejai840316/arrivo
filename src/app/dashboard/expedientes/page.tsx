...
import { ArrowLeft, FileText, Clock, CheckCircle2, AlertCircle, ChevronRight } from 'lucide-react';

export const metadata = {
  title: 'Mis Expedientes | Arrivo',
  description: 'Gestiona tus expedientes y trámites migratorios con Arrivo.',
};

export default function ExpedientesPage() {
  // Datos mock para tener interfaz visual mientras conectamos la DB real
    ...
    <div className="max-w-6xl mx-auto py-12 px-4 space-y-8">
      ...
      <div className="grid grid-cols-1 gap-4">
        {expedientesMock.map((exp) => (
          <Link href={`/dashboard/proced/${exp.id}`} key={exp.id} className="block group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-900 focus-visible:ring-offset-2 rounded-2xl">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 group-hover:border-blue-300 group-hover:shadow-md transition-all flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
